<?php require_once('header.php') ;
 ...
 if(isset($_POST['add_teacher_btn'])){
    ...
    if(empty($teacher_id)){
        ...
        $error = "Account Number is Rerquired!";
    }
    else{
        //update payment history
        $stm2 = $pdo->prepare("UPDATE teacher SET balance=balance + ? , last_amount=? WHERE    id=?");
        ...
        $success = "Amount Send Succedssfully!";
   ...
   <div class="row">
    <div class="col-md-6 grid-margin stretch-card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="amount">Sallary Amount:</label>
            ...
            <button type="submit" name="add_teacher_btn" class="btn btn-gradient-primary mr-2">Send Payment</button>
            </form>
        </div>
        </div>
    </div>
